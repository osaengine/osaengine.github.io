...
Недавно я запустил бэктест торговой стратегии на базе **TD3 (Twin Delayed Deep Deterministic Policy Gradient)** — одного из самых современных DRL алгоритмов. Результаты за 6 месяцев на портфеле из 10 акций:
...
Я запустил TD3 агента на реальном счёте (с малым капиталом $5000) несколько месяцев назад:
