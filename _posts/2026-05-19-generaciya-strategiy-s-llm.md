...
description: "Практические эксперименты с генерацией торговых стратегий через LLM: от простых индикаторных стратегий до сложных ML-моделей. Что работает, что провалилось, и как правильно формулировать промпты."
date: 2026-05-19
