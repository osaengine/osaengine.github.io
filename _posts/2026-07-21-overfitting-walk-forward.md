...
Недавно я разработал торговую стратегию на основе RSI и MACD. Бэктест на исторических данных показал феноменальные результаты:
...
Я был в восторге! Запустил стратегию на реальном счёте. Через месяц результаты:
