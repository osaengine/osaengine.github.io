...
Ранее я создал простого LLM-трейдера на базе ChatGPT:
...
| **Стоимость (ChatGPT)** | $45 | $42 | $48 | $45/month |
...
Один запрос ChatGPT с полным контекстом (рынок + новости + фундаментальные данные + история) стоил ~$0.15. При ежедневной торговле по 3 акциям: **$0.15 * 3 * 30 дней = $13.50/месяц**. Приемлемо, но масштабируется плохо.
...
- 3 агента Research team × 2 раунда дебатов = 6 вызовов ChatGPT
- 1 Facilitator = 1 вызов
- 3 агента Trading team = 3 вызова
- 2 агента Risk team × 1 раунд = 2 вызова
- 1 Facilitator = 1 вызов

**Итого: 13 вызовов ChatGPT на одно решение**
...
**Новая стоимость:**
- 6 вызовов ChatGPT (research) = $0.006
- 4 вызова ChatGPT (facilitators + risk) = $0.12
- 3 вызова ChatGPT (trading) = $0.003
