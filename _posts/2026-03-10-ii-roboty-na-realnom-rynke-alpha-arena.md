...
Мы [будем экспериментировать с гибридным подходом]({{site.baseurl}}/2026/03/31/eksperiment-llm-plus-klassika.html) позже.
...
Мы [разберём это подробнее]({{site.baseurl}}/2026/05/12/llm-kak-timlid-kvant.html) в следующих статьях.
