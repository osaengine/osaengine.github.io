...
date: 2026-06-16
categories: ai ml feature-engineering
excerpt: "Как использовать LLM для генерации тысяч признаков, автоматического отбора важных фичей и превращения идей трейдера в код за минуты. Реальный опыт создания ML-стратегии с помощью ИИ."
---
