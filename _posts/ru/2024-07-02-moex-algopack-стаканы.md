...
Недавно я опубликовал статью о подключении к MOEX через [WebSocket с использованием C#](/ru/blog/moex-algopack-csharp-websocket/). В чате АлгоПак последовала критика качества кода, что вдохновило меня на улучшение и доработку.
